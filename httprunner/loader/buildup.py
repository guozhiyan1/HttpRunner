...
def load_project_data(test_path, dot_env_path=None):
    ...
    mapping_without_sercret = copy.deepcopy(project_mapping)
    for i in mapping_without_sercret['env']:
        if "secret" in i:
            mapping_without_sercret['env'][i] = "this is secret"
    print("project_mapping_without_sercret", mapping_without_sercret)
