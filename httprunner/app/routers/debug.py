...
@router.post("/gmc-http-autotest/debug/testcase", tags=["debug"])
...
# @router.post("/gmc-http-autotest/debug/api", tags=["debug"])
...
#
#
# @router.post("/gmc-http-autotest/debug/testcases", tags=["debug"])
